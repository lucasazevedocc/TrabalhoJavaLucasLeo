...
public class PanelRemoverAluno extends JPanel implements PadraoPanel, ActionListener {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == this.botaoRemover) {
            new AlunoDao().deletarAlunoPorId(Integer.parseInt(this.getCampoCodigoAluno().getText()));
        } else {
