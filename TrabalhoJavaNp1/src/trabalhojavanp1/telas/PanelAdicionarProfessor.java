...
public class PanelAdicionarProfessor extends JPanel implements PadraoPanel,ActionListener{
    ...
    public final void initViews() {
        ...
        this.getRadioButtonBacharelado().addActionListener((ActionEvent ae) -> {
            professor.setFormacao(((JRadioButton)ae.getSource()).getText());
        });
        this.setRadioButtonDoutorado(new JRadioButton("Doutorado",false));
        this.getRadioButtonDoutorado().addActionListener((ActionEvent ae) -> {
            professor.setFormacao(((JRadioButton)ae.getSource()).getText());
        });
        this.setRadioButtonMestrado(new JRadioButton("Mestrado",false));
        this.getRadioButtonMestrado().addActionListener((ActionEvent ae) -> {
            professor.setFormacao(((JRadioButton)ae.getSource()).getText());
        });
    ...
    private boolean professorIsValid(){
        return this.professor != null && this.professor.getNome() != null && !this.professor.getNome().isEmpty() && this.professor.getFormacao() != null && !this.professor.getFormacao().isEmpty()
                && this.professor.getDisciplinas() != null && !this.professor.getDisciplinas().isEmpty();
    }
    
    public final void gerarDisciplinas(){
