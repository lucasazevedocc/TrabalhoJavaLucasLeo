...
public class PanelAdicionarDisciplina extends JPanel implements PadraoPanel,ActionListener{
    ...
    public void actionPerformed(ActionEvent ae) {
        if(ae.getSource() == this.botaoSalvar){
            if(!salvando){
                this.salvando = true;
                this.disciplina = new Disciplina();
                this.disciplina.setNomeDisciplina(this.campoNomeDisciplina.getText());
    ...
    private boolean disciplinaIsValid(){
        return this.disciplina != null && this.disciplina.getNomeDisciplina() != null && !this.disciplina.getNomeDisciplina().isEmpty();
    }
